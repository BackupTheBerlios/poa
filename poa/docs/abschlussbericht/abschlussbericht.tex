...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.19 2004/06/08 04:41:53 kilgus Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,titlepage,12pt,ngerman]{scrbook}
\usepackage{../common/header}
\RequirePackage{hhline}

\RCSdef $Revision: 1.19 $
\RCSdef $Date: 2004/06/08 04:41:53 $
...
Dieses Diagramm zeigt den hohen Anteil der graphischen
...
haben. Es sind nur die Top zehn Dateien angegeben, aber jede Datei wurde
von mindestens zwei Teammitgliedern bearbeitet.
