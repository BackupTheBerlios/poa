...
%% Anforderungen
%% $Id: anforderungen.tex,v 1.5 2003/06/01 20:12:00 keulsn Exp $
...
Die Programmierumgebung ``Offener Antrieb`` soll eine grafische Oberfläche
...
Funktionsblöcken (CPUs, Cores, E/A-Blöcke), die in CPLD-Layouts einbettbar
...
\subsection{Hardware}
Die minimalen Hardware Anforderungen entsprechen denen der Zielplatform.

\subsection{Mengengerüst}
Eine CPLD hat maximal 20 Cores und 10 CPUs.
