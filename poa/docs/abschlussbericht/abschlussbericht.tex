...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.15 2004/06/07 00:23:56 squig Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\RCSdef $Date: 2004/06/07 00:23:56 $
...
(siehe auch \ref{developer by file}), damit wurde die Qualität laufend
...
Erfassung der Arbeitszeit zurück gegriffen. Leider zeichnet sich
...
inklusive einer Zeitabschätzung und Fortschrittserfassung. Letzters
...
Fehlerberichten und Aufgaben empfohlen werden, allerdings gilt der
nicht triviale Administrationsaufwand, der Kenntnisse im J2EE Bereich
vorraussetzt nicht zu unterschätzen. Durch einen Fehler bei der
...
Verständniss für die mit POA zu programmierende Hardware, wäre es
nicht möglich gewesen ein sinnvolles Bedienkonzept zu entwickeln. Es
hat auch die Kommunikation mit dem Kunden erleichert, daß ich, wie die
...
koordinieren, daß eine produktive Teamdynamik entsteht, alle
...
Athmosphäre des Projekts, die sich auch in sozialen Aktivitäten
...
Kommuikation mit unserem Kunden Christian Kramer war sehr kooperativ.
