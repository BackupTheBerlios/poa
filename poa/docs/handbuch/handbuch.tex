...
%% Angebot
%% $Id: handbuch.tex,v 1.7 2004/02/18 18:21:32 neco Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,titlepage,12pt,ngerman]{scrbook}
\usepackage{../common/header}

\RCSdef $Revision: 1.7 $
\RCSdef $Date: 2004/02/18 18:21:32 $
...
zu integrieren. Diese Plattform wird am ISW\footnote{Institut f"ur Werkzeugmaschinen} an der Universität Stuttgart kurz als ``Offener Antrieb''
bezeichnet.  \par
...
Die hier Kurz beschriebenen Funktionen werden in den sp"ateren Kapiteln n"aher erkl"art.\par
...
\end{figure}
F"ur Downloadeinstellungen w"ahlt man den Dateireiter {\bf Download}. Hier kann man in der Auswahlbox den Seriellen Port einstellen.\par
...
Diese Option ist f"ur {\bf Muxbl"ocke} nicht verf"ugbar.
...
Um das Offset einzugeben, kann man entweder direkt mit der Maus ins Textfeld {\bf Offset} klicken und die Offsetzeit in Nanosekunden eingeben oder man benutzt die Pfeiltasten neben dem Textfeld.
Diese Option ist f"ur {\bf Muxbl"ocke} nicht verf"ugbar.
\subsubsection{Takt eingeben}
Um den Takt einzugeben, kann man entweder direkt mit der Maus ins Textfeld {\bf Clock} klicken und die Taktfrequenz in Nanosekunden eingeben oder man benutzt die Pfeiltasten neben dem Textfeld.
Diese Option ist f"ur {\bf Muxbl"ocke} nicht verf"ugbar.
\subsubsection{Laufzeit eingeben}
Um die Laufzeit einzugeben, kann man entweder direkt mit der Maus ins Textfeld{\bf Runtime} klicken und die Laufzeit in Nanosekunden eingeben oder man benutzt die Pfeiltasten neben dem Textfeld.
Diese Option ist f"ur {\bf Muxbl"ocke} und {\bf Inputbl"ocke} nicht verf"ugbar.
