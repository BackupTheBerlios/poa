...
% $Id: pir.tex,v 1.25 2005/07/11 15:10:25 keulsn Exp $
...
%
%\sprache{englisch} % Default ist natuerlich deutsch.

% Die folgenden neun Angaben, au"ser \art und \institut, m"ussen immer
% angegeben werden.  Mehrere Zeilen werden mit \\ getrennt.
%

\pruefer{Prof.~Dr.~rer.~nat.~habil.~Paul~Levi}
\betreuer{Dipl.-Inform.~Uwe-Philipp~Käppeler\\Dipl.-Ing.(BA)~Jean~Joswig}

\begonnen{1.~Dezember 2004}
\beendet{22.~Juni~2005}

\titel{Erkennung des Vorhandenseins von Personen im Raum}
\autor{Anselm~Garbe}
\autor{Marcel~Kilgus}  % bei zwei Autoren
\autor{Steffen~Keul}

\art{Fachstudie}   %% Default ist \art{Diplom}, also eine Diplomarbeit
\nummer{42}  % Nummer der Studien-/Diplomarbeit
...
Darüber hinaus wurde die Receiver-Operator-Characteristic Curve
zur Veranschaulichung der Güte aller Durchläufe (beide Szenarien
...
Curve zur Veranschaulichung der Güte von CalcOpticalFlowPyrLK unter den
