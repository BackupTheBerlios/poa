...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.4 2004/05/17 03:44:22 kilgus Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,titlepage,12pt,ngerman]{scrbook}
\usepackage{../common/header}
\RCSdef $Revision: 1.4 $
\RCSdef $Date: 2004/05/17 03:44:22 $
...
Die einzig verbleibende Option einer hardwaregstützten Instrumentierung des Codes 
