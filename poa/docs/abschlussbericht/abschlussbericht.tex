...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.31 2004/06/15 21:48:33 squig Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,titlepage,12pt,ngerman]{scrbook}
\usepackage{../common/header}
\RequirePackage{hhline}

\RCSdef $Revision: 1.31 $
...
Semester studierten. Auf dem Bild \ref{poa-team} zusehen sind Necati
Aydin, Marcel Kilgus, Tammo van Lessen, Anselm Garbe, Stefan Hauser
und Steffen Pingel (von links). Steffen Keul hielt sich zum Zeitpunkt
der Aufnahme bereits auf Grund eines Praktikums im Ausland auf.
...
\begin{figure}[h!]
  ...
  \end{center}
  \caption{POA-Team}\label{poa-team}
\end{figure}
