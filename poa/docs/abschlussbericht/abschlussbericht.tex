...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.36 2004/06/16 19:01:56 vanto Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\RCSdef $Date: 2004/06/16 19:01:56 $
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=12.5cm]{zeitverteilung}
  \caption{Zeitliche Aufwandsverteiung auf die Entwickler}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=12.5cm]{phasenverteilung}
...
Verwaltet wurde das Projekt auf der Open-Source Plattform Berlios, die
...
plattformunabh"angig realisiert werden.\newline
...
Zugriff auf ein Altera Excalibur PLD Entwicklerboard mit einem Apex 
EP20K200 Baustein, wobei mir die Aufgabe zugefallen ist unser Projekt 
und dieses Board zu verheiraten. 
Zu diesem Zweck habe ich mich noch mit PLDs im Allgemeinem sowie mit 
dem Entwicklerboard und der PLD Entwicklungsumgebung Quartus II 
