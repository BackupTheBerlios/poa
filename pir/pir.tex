...
% $Id: pir.tex,v 1.18 2005/06/09 10:12:53 garbeam Exp $
...
\caption{Receiver Operator Charakteristik, erstes Szenario, Eigene
Implementierung}
\end{figure}

\begin{figure}
\includegraphics[width=7cm,angle=270]{impl/roc-optical-flow-2.log.ps}
\caption{Receiver Operator Charakteristik, zweites Szenario, Eigene
Implementierung}
\end{figure}
\end{center}

Aus den Charakteristiken ist ersichtlich, dass die eigene
...
Bildsequenzen berücksichtigen und bewegte Bereiche verfolgen und
...
Datenquelle angegeben. Wenn so eine Konfiguration gestartet ausgeführt
...
http://www.montivision.com/support/documentation/noframes/source/filter/optical_flow_filter.htm
\end{thebibliography}
