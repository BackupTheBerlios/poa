...
%% Anforderungen
%% $Id: anforderungen.tex,v 1.9 2003/06/14 16:45:40 garbeam Exp $
...
E/A-Bausteins auf einem CPLD wieder. Dabei sollen an allen genannten
...
für CPLD-CPU-Block Object-Code verwendet, das vom Kunden zu liefern
...
keinem Ergeniss führen, kann die Optimierungsfunktionalität nicht
garantiert werden.
...
das CPLD heruntergeladen werden können. Um diese Anforderung umsetzen zu 
