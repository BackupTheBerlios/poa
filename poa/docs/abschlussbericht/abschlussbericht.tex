...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.7 2004/05/18 14:30:50 garbeam Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,titlepage,12pt,ngerman]{scrbook}
\usepackage{../common/header}
\RCSdef $Revision: 1.7 $
\RCSdef $Date: 2004/05/18 14:30:50 $
...
Seit Projektbeginn war ich mich neben den allgemeinen
...
die eine MDI (Multiple Document Interface) Architektur unterstützt
