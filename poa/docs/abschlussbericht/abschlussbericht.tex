...
%% Abschlussbericht
%% $Id: abschlussbericht.tex,v 1.18 2004/06/07 22:20:37 vanto Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\RCSdef $Date: 2004/06/07 22:20:37 $
...
\item Vergrössern und verkleinern der Netzwerkansicht
...
und der Signalweg durch die Verbindung von Blöcken festgelegt zu einem
...
Konsistenz geprüftwerden. In einem Dialog wird in einer Baumansicht
eine Liste mit möglichen Problem, wie beispielsweise nicht verbundene
...
beinhaltete desweiteren eine Risikioanalyse und eine Beschreibung des
...
einem Form eines Dokuments beschrieben. Dieses Dokument enthält eine
detailierte Beschreibung der POA Architektur. Es soll bei einer
möglichen Weiterentwicklung der Software als Orientierungsshilfe
...
Gcov ist Teil der GNU gcc Kompilersuite, die zur Übersetzung von POA
...
die Anweisungsüberdeckung in einem HTML Frameset ähnlich des
...
Der Auftragnehmer bestand wie bereits erwähnt aus einem Entwicklerteam
von sieben Studenten der Softwaretechnik, die zu Beginn des Projekts
im sechsten Semester studierten, namentlich Necati Aydin, Anselm
Garbe, Stefan Hauser, Steffen Keul, Marcel Kilgus, Steffen Pingel und
Tammo van Lessen.
...
anschliessend von dem gesammten Team in einem Review geprüft. Die
Qualität des Quellcodes wurde in Form von Peer-Reviews laufend
geprüft. Die einzelnen Quellcode Dateien konnten vom jedem Entwickler
...
dem Auftraggeber durchgeführt und eine Rückmeldung über das Ergebniss
...
stark erleichtert haben und motivierend auf die Entwickler gewirkt
haben.
...
Verbindungen und Blöcken berücksichtigt, aber einen höheren Aufwand
hat. Zur Qualitätssicherung wurde ein CppUnit basierter
...
Quellcodes geprüft. Im Ergebniss wurden einige Hauptfehler und mehrere
...
Im Nachhinein kann festgestellt werden, daß es sicherlich positive
Auswirkungen auf die Qualität gehabt hätte Quellcode Reviews bereits
zu einem früheren Zeitpunkt und regelmässig durchzuführen.
...
während des Entwurfs enstandenen Headerdateien zu erklären. Die
...
Dieses Diagramm zeigt den Anteil den hohen Anteil der graphischen
Benutzeroberfläche (GUI, View). Wobei auch anderen Modulen wie
Scheduling und Download Benutzerschnittstellen enthalten sind.
...
von Entwicklern die jeweils gemeinsam an einer Datei gearbeitet
haben. Es sind nur die Top zehn Dateien angegeben, aber weniger als
zwei Bearbeiter würde auf keine der Dateien zutreffen.
...
die Morgenstunden reichen. Vollkommen atypisch die Commits um zwischen
...
Der Versuch Teammeetings vormittags 14.00 Uhr 
...
Weiterhin übernahm ich den von Marcel begonnenen Scheduling-Dialog
führte ihn zu dem jetzigen Stand. Dazu implementierte ich die
Darstellung der Blöcke sowie die Zoomfunktion auf der Zeitachse.

Neben vielen kleineren Verfeinerungen die an der GUI vornahm startete
ich das Unterprojekt GCover. GCover verabeitet die Ausgabe des GNU
...
jederzeit sehr gut absprechen. So gab es kaum vor, dass Schnittstellen
...
Projekt dieser Größe. Hinzu kam, dass mit sowohl die
...
objektorientieren Programmierens verstanden hat, ist es eher zweit
rangig in welcher Sprache man implementiert. Die Besonderheiten von
...
Observer-Patterns in die Programmiersprache ermöglicht ist sehr
